    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        LeadId = c.String(nullable: false, maxLength: 128),
                        Email = c.String(),
                        LeadNotes = c.String(),
                        FirstName = c.String(),
                        LastName = c.String(),
            ...
            Sql("ALTER TABLE dbo.MarketingLead ADD DisplayName AS FirstName + ' ' + LastName");
            Sql("ALTER TABLE dbo.MarketingLead ADD LastNameFirst AS LastName + ', ' + FirstName");
            Sql("ALTER TABLE dbo.MarketingLead ADD PublicName AS FirstName + ' ' + SUBSTRING(LastName, 1, 1) + '.'");
